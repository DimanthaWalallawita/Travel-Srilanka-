<?php session_start();
		...
		$sql = "UPDATE `tblfoodadvertisement` SET `productName` = '".$productname."', `item_price` = '".$description."', `publish` = '".$status."', `imagePath` = '".$image."', `contactNumber` = '".$contactNumber."', `category` = '".$category."' WHERE `tblfoodadvertisement`.`advertisementID` = ".$_SESSION["id"].";";
