...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<br />
			<br />
			<h1 align="center">OUR FOOD STORE</h1><br />
			<br /><br />
			<?php
				$query = "SELECT * FROM tblfoodadvertisement ORDER BY advertisementID ASC";
				...
				?>
			<div class="col-md-4">
				<form method="post" action="FoodCart.php?action=add&id=<?php echo $row["advertisementID"]; ?>">
