...
<div class="dropdown-menu" aria-labelledby="navbarDropdown1"> <a class="dropdown-item" href="#">Action</a> <a class="dropdown-item" href="#">Another action</a>
  	    ...
  	    <h1 class="text-center">PERSONAL GUIDE ADVERTISEMENT</h1>
<br>
<br>
		<?php
			...
			$sql = "SELECT * FROM `tblguideadvertisement` WHERE `email` = '".$_SESSION["username"]."';";
    	...
    	<div class="card">
      	...
      	<div class="container">
			...
			<p>
				<button style="background-color: dimgrey; border-color: chartreuse; color: white" class="edditedB"><a href="EditGuideAdvertisement.php?id=<?php echo $row["advertisementID"]; ?>">Edit</a></button>
				
				<button style="background-color: dimgrey; border-color: chartreuse; color: white" class="edditedB"><a href="DeleteGuideAdvertisement.php?id=<?php echo $row["advertisementID"]; ?>">Delete</a></button>
			</p>
      	</div>
    	</div>
